...
export default function StationFlyersPage() {
  ...
  // 年ごとにグループ化
  const groupedByYear = filteredFlyers.reduce(
    (acc, flyer) => {
      ...
      <div className="bg-white shadow-sm sticky top-0 z-40">
        <div className="max-w-6xl mx-auto px-4 py-4 flex items-center justify-between">
          <Link
            ...
            className="text-[var(--color-logo-dark-green)] font-bold text-lg hover:opacity-80 transition-opacity"
          >
            ← ステーションに戻る
          </Link>
          <h1
        ...
        <div className="mb-8 flex flex-wrap gap-2 justify-center">
          <button
            ...
            className={`px-4 py-2 rounded-full font-medium transition-all ${
              selectedType === "all"
                ? "bg-[var(--color-logo-dark-green)] text-white"
                : "bg-white text-[var(--color-logo-dark-green)] hover:bg-gray-100"
            }`}
          >
            すべて
          </button>
          ...
          <div className="space-y-12">
            {sortedYears.map((year) => (
              <div key={year}>
                {/* 年のタイトル */}
                <h2
                  className="font-bold text-[var(--color-logo-dark-green)] pb-2 border-b-2 border-[var(--color-logo-dark-green)]"
                  style={{
                  ...
                  {groupedByYear[year].map((flyer) => (
                    <div key={flyer.id} className="group flex flex-col">
                      ...
                      <div className="mt-4 text-center">
                        <h3 className="font-bold text-[var(--color-logo-dark-green)]">
                          {flyer.title}
                        </h3>
      ...
      {fullscreenData && (
        ...
        >
          ...
          >
            <Image
              src={
                fullscreenData.isFront
                  ? fullscreenData.frontImage
                  : fullscreenData.backImage
              }
