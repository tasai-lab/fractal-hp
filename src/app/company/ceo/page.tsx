...
経営者として、私の役割は「仕組みをつくる人」であり「仕組みを壊す人」でもある。完成したら次の課題へ。常に進化し続ける組織でありたいと思っています。`,
  ...
  vision: `「フラクタルこそが市場のベンチマークだ」と自信を持って言える組織をつくること。それが私の目標です。
...
品質には妥協しない。中長期的な視点を持ってPDCAを回し続ける。それは「フラクタル」というブランドの確立であり、関わるすべての人の充実につながると信じています。`,

  message: `ここまで読んでくださり、ありがとうございます。

誰にでも「得意なこと」と「不得意なこと」があります。私もそう。

私は個別性を理解することや仕組みを作るのは得意ですが、一人ひとりに寄り添った細やかなケア（=行動）は苦手な傾向にあります。だからこそ、チームとして苦手を補完して働きたい。
