...
難しい課題を解くことに喜びを感じるタイプ。逆に、すべてが整って安定した状態になると、次の挑戦を探し始めてしまいます。`,
  ...
  leadership: {
    style: "仕組みで回る組織をつくる",
    description: `経営で最も大切にしているのは「属人化しない仕組みづくり」です。

誰かが休んでも、誰かが抜けても、サービスの質が落ちない。特定の人に依存しない組織こそが、本当に強い組織だと考えています。

そのために、業務の標準化・IT化・情報共有の仕組みを徹底的に整備する。「人」ではなく「仕組み」で動く組織を目指しています。

一方で、仕組みだけでは人は動きません。メンバーの一人ひとりが「なぜこの仕組みが必要か」を理解し、自分ごととして改善に参加できる文化も同時に育てています。

経営者として、私の役割は「仕組みをつくる人」であり「仕組みを壊す人」でもある。完成したら次の課題へ。常に進化し続ける組織でありたいと思っています。`,
  },

  vision: `フラクタルこそが市場のベンチマークとなること。時代に取り残されず、時代とともに進む組織を作ること。それが私の目標です。

効率化だけを追求するのではありません。社員の満足度、ワークライフバランスの最適化、そして顧客満足度。この中には定量評価できないものもあり、定性評価も同じくらい重要だと考えています。

会社としては「個性」を大事に、事業としては「バランス」を大事に。一見相反するこの2つの側面を両立させる組織を目指しています。

品質には妥協しない。中長期的な視点を持ってDAPAEを回し続ける。それは「フラクタル」というブランドの確立であり、関わるすべての人の充実につながると信じています。`,

  message: `ここまで読んでくださり、ありがとうございます。

誰にでも「得意なこと」と「不得意なこと」があります。私もそう。

私は個別性を理解することや仕組みを作るのは得意ですが、一人ひとりに寄り添った細やかなケア（=行動）は苦手な傾向にあります。

ひとりではできないこと、効率が悪いことを、得意な人と協力して補完し合う。それが理想の関係であり、理想の組織だと考えています。
        ...
        <main className="max-w-5xl mx-auto px-4 md:px-6 pt-10 md:pt-16 pb-20 md:pb-24 flex flex-col gap-16 md:gap-24">
          ...
          <section>
            <FadeIn className="space-y-6 text-center max-w-3xl mx-auto">
              ...
              <p className="heading-mincho text-xl md:text-2xl text-[var(--color-ink-soft)] mt-2">
