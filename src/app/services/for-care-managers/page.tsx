...
export default function ServicesForCareManagersPage() {
  ...
  return (
    <>
      ...
      <main className="pt-14 lg:pt-20 bg-white">
            ...
            <div className="section-content">
              <div className="section-card section-card-mint">
                <nav className="flex items-center gap-2 text-xs text-[var(--color-muted)] mb-4">
                  ...
                  <span>/</span>
                  <Link href="/services" className="hover:underline">サービス案内</Link>
                  <span>/</span>
        ...
        {/* 受け入れ可能な身体の状況 */}
        <section className="section-wrapper bg-gradient-to-br from-gray-50 to-white relative overflow-x-hidden">
